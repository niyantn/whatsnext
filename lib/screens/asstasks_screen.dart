...
class AssTaskScreen extends StatefulWidget {
  @override
  _AssTaskScreenState createState() => _AssTaskScreenState();
}
class _AssTaskScreenState extends State<AssTaskScreen> {
  Future<TaskList> usertasks; 

  Future<TaskList> getTasks(user, pass) async{
    String encoded = base64.encode(utf8.encode("$user:$pass"));
    final response = await http.get(
      'https://whatsnext.page/api/tasks?assignee=$user',
